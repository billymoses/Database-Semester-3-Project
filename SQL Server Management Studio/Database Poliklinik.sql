...
-- create table bernama spesialisasi
CREATE TABLE SPESIALISASI
(Kode_Spesial CHAR(5) NOT NULL PRIMARY KEY,
Spesialis VARCHAR(25) NOT NULL);

-- create table n dokter
CREATE TABLE DOKTER
(Id_Dokter CHAR(5) NOT NULL PRIMARY KEY,
Nama_Depan VARCHAR(15) NOT NULL,
Nama_Belakang VARCHAR(15),
Spesialis CHAR(5) FOREIGN KEY REFERENCES SPESIALISASI(Kode_Spesial) ON UPDATE CASCADE ON DELETE CASCADE,
...
-- create table resep
CREATE TABLE RESEP
(Id_Resep CHAR(10) NOT NULL PRIMARY KEY,
Pasien_Id CHAR(5) NOT NULL FOREIGN KEY REFERENCES PASIEN(Id_Pasien) ON UPDATE CASCADE ON DELETE CASCADE,
Dokter_Id CHAR(5) NOT NULL FOREIGN KEY REFERENCES DOKTER(Id_Dokter) ON UPDATE CASCADE ON DELETE CASCADE,
Tanggal DATE NOT NULL,
Harga NUMERIC(10,2));

-- create table kategori obat
CREATE TABLE KATEGORI_OBAT -- dibuat dulu karena table obat referensi kesini
(Id_Kategori CHAR(5) NOT NULL PRIMARY KEY,
Kategori VARCHAR(20) NOT NULL);

-- Create Table OBAT
CREATE TABLE OBAT
(Id_Obat CHAR(5) NOT NULL PRIMARY KEY,
Nama_Obat VARCHAR(25) NOT NULL,
Harga_Satuan NUMERIC(10,2) NOT NULL,
Kategori CHAR(5) FOREIGN KEY REFERENCES KATEGORI_OBAT(Id_Kategori) ON UPDATE CASCADE ON DELETE CASCADE);

-- Create Table DETAIL_OBAT
CREATE TABLE DETAIL_OBAT -- dibuat akhir karena perlu referensi dari OBAT
(Id_Obat CHAR(5) NOT NULL FOREIGN KEY REFERENCES OBAT(Id_Obat) ON UPDATE CASCADE ON DELETE CASCADE,
Id_Resep CHAR(10) NOT NULL FOREIGN KEY REFERENCES RESEP(Id_Resep) ON UPDATE CASCADE ON DELETE CASCADE,
Jumlah INT NOT NULL,
...
-- Insert into RESEP
INSERT INTO RESEP(Id_Resep,Pasien_Id,Dokter_Id,Tanggal)
VALUES('R250115001','P0001','DR011','2015/1/25'),
('R250115002','P0009','DR001','2015/1/25'),
('R260115001','P0008','DR007','2015/1/26'),
('R270115001','P0014','DR003','2015/1/27'),
('R300115001','P0010','DR010','2015/1/30'),
('R300115002','P0013','DR003','2015/1/30'),
('R010215001','P0009','DR001','2015/2/1'),
('R010215002','P0003','DR009','2015/2/1'),
('R010215003','P0010','DR010','2015/2/1'),
('R020215001','P0005','DR004','2015/2/2'),
('R020215002','P0009','DR001','2015/2/2'),
('R020215003','P0014','DR012','2015/2/2'),
('R030215001','P0005','DR004','2015/2/3'),
('R030215002','P0003','DR009','2015/2/3');

SELECT Id_Resep,
Pasien_Id,
Dokter_Id,
Tanggal,
ISNULL(CAST(Harga AS VARCHAR), '') AS 'Harga' FROM RESEP
...
OBAT.Harga_Satuan AS harga_satuan,
KATEGORI_OBAT.Kategori AS kategori
FROM OBAT, KATEGORI_OBAT
WHERE OBAT.Kategori = KATEGORI_OBAT.Id_Kategori AND
Harga_Satuan < 50000; -- harga dibawah Rp 50.000
...
SELECT Id_Pasien AS id_pasien,
(Nama_Depan + ' ' + Nama_Belakang) AS nama_pasien,
Gender AS gender, 
Alamat AS alamat,
Umur AS umur
FROM PASIEN
...
SELECT DISTINCT (PASIEN.Nama_Depan + ' ' + PASIEN.Nama_Belakang) AS nama_pasien,
PASIEN.Umur AS umur, 
(DOKTER.Nama_Depan + ' ' + DOKTER.Nama_Belakang) AS dokter
FROM PASIEN, DOKTER, RESEP, SPESIALISASI
WHERE RESEP.Pasien_Id = PASIEN.Id_Pasien AND -- gk pake inner join gara-gara II. Basic SQL gk dipake
RESEP.Dokter_Id = DOKTER.Id_Dokter AND
...
SELECT RESEP.Id_Resep AS id_resep,
RESEP.Tanggal AS tanggal
FROM RESEP, DETAIL_OBAT, OBAT
WHERE RESEP.Id_Resep = DETAIL_OBAT.Id_Resep AND
DETAIL_OBAT.Id_Obat = OBAT.Id_Obat AND
OBAT.Nama_Obat = 'Cardiject Vial'
ORDER BY RESEP.Tanggal ASC;
...
FROM OBAT, DETAIL_OBAT
WHERE OBAT.Id_Obat = DETAIL_OBAT.Id_Obat AND
DETAIL_OBAT.Jumlah > 2; -- jumlah obat > 2